   ...
   const data: ReceiptTemplateData = {
     ...
     total: (order.total || 0).toFixed(2),
       customHeader: template.customHeader || '',
        ...
        paperWidth: printerSettings?.receipts?.paperWidth,
        fontSize: printerSettings?.receipts?.fontSize,
        headingFont: printerSettings?.receipts?.headingFont || 'Arial',
        bodyFont: printerSettings?.receipts?.bodyFont || 'Helvetica',
        lineSpacing: printerSettings?.receipts?.lineSpacing || 1.2,
        autoPrint: printerSettings?.receipts?.autoPrint || false,
...
export async function renderInvoiceTemplate(
  ...
  const data: InvoiceTemplateData = {
    ...
    qrCodeUrl: qrCodeBase64,
    paperWidth: printerSettings?.invoices?.paperWidth,
    ...
    fontSize: printerSettings?.invoices?.fontSize,
    headingFont: printerSettings?.invoices?.headingFont || 'Arial',
    bodyFont: printerSettings?.invoices?.bodyFont || 'Helvetica',
...
export async function renderQuoteTemplate(
  ...
  const data: QuoteTemplateData = {
    ...
    qrCodeUrl: '',
    paperWidth: printerSettings?.quotes?.paperWidth,
    ...
    fontSize: printerSettings?.quotes?.fontSize,
    headingFont: printerSettings?.quotes?.headingFont || 'Arial',
    bodyFont: printerSettings?.quotes?.bodyFont || 'Helvetica',

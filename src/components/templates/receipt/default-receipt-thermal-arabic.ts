...
<head>
  ...
  <title>إيصال</title>
    <style>
     body { font-family: 'Amiri', serif; margin: {{marginTop}}mm {{marginRight}}mm {{marginBottom}}mm {{marginLeft}}mm; padding: {{paddingTop}}mm {{paddingRight}}mm {{paddingBottom}}mm {{paddingLeft}}mm; font-size: 12px; max-width: {{paperWidth}}px; }
